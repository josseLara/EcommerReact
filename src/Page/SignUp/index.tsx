...
function SignUp() {
     ...
     return (
          <div className="singUp">
               ...
               <svg className="waveSing" style={{ transform: "rotate(0deg)", transition: "0.3s" }} viewBox="0 0 1440 490" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="rgba(0, 0, 0, 1)" offset="0%"></stop><stop stop-color="rgba(54, 80, 208, 1)" offset="100%"></stop></linearGradient></defs><path style={{ transform: "translate(0, 0px)", opacity: "1" }} fill="url(#sw-gradient-0)" d="M0,294L40,285.8C80,278,160,261,240,261.3C320,261,400,278,480,285.8C560,294,640,294,720,269.5C800,245,880,196,960,179.7C1040,163,1120,180,1200,179.7C1280,180,1360,163,1440,163.3C1520,163,1600,180,1680,204.2C1760,229,1840,261,1920,269.5C2000,278,2080,261,2160,245C2240,229,2320,212,2400,236.8C2480,261,2560,327,2640,343C2720,359,2800,327,2880,310.3C2960,294,3040,294,3120,294C3200,294,3280,294,3360,285.8C3440,278,3520,261,3600,220.5C3680,180,3760,114,3840,114.3C3920,114,4000,180,4080,179.7C4160,180,4240,114,4320,81.7C4400,49,4480,49,4560,73.5C4640,98,4720,147,4800,204.2C4880,261,4960,327,5040,294C5120,261,5200,131,5280,122.5C5360,114,5440,229,5520,302.2C5600,376,5680,408,5720,424.7L5760,441L5760,490L5720,490C5680,490,5600,490,5520,490C5440,490,5360,490,5280,490C5200,490,5120,490,5040,490C4960,490,4880,490,4800,490C4720,490,4640,490,4560,490C4480,490,4400,490,4320,490C4240,490,4160,490,4080,490C4000,490,3920,490,3840,490C3760,490,3680,490,3600,490C3520,490,3440,490,3360,490C3280,490,3200,490,3120,490C3040,490,2960,490,2880,490C2800,490,2720,490,2640,490C2560,490,2480,490,2400,490C2320,490,2240,490,2160,490C2080,490,2000,490,1920,490C1840,490,1760,490,1680,490C1600,490,1520,490,1440,490C1360,490,1280,490,1200,490C1120,490,1040,490,960,490C880,490,800,490,720,490C640,490,560,490,480,490C400,490,320,490,240,490C160,490,80,490,40,490L0,490Z"></path></svg>
          </div>
     );
}
